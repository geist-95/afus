  ...
  return (
    <>
      <div className="hidden md:block relative w-full h-[476px] bg-background">
        <div className="w-full px-4 sm:px-6 lg:px-8 h-full">
          <div className="grid md:grid-cols-3 gap-6 items-stretch h-full">
            ...
            <button
              className="h-full block group cursor-pointer text-left"
              onClick={() => setOnboardingOpen(true)}
            >
              <div
      ...
      <div className="md:hidden bg-[#1b0f2b] py-10 px-6 text-center arabic-frame">
        <h2 className="text-2xl font-bold text-white !font-ariom">The world of handmade</h2>
        <p className="text-white/70 mt-3 text-sm leading-relaxed">Launch your digital storefront and connect with buyers across Morocco.</p>
        <button
          onClick={() => setOnboardingOpen(true)}
